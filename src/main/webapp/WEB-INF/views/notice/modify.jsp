...
<head>
  ...
  function updateNotice() {
	...
	/* 	document.getElementById("writeform").action = "${root}/notice.do/";
		...
		document.getElementById("writeform").action = "${root}/notice.do/update";
	  	document.getElementById("writeform").submit();
	  	alert("글 수정이 완료되었습니다.");
	}
  }
  ...
  function mvlist() {
		document.location.href = "${root}/notice.do/mvlist";
	}
...
<body>
	...
	<div class="container" align="center">
		...
		<input class="myinput" type="hidden" id="no" name="no" value="${notice.no }"> 
			<div class="form-group" align="left">
				<label for="subject">제목 </label>
				<input type="text" class="myinput " style="width:100%;" id="subject" name="subject" value = "${notice.subject}">
			</div>
			<div class="form-group" align="left">
				<label for="content">내용 </label>
				<textarea class="mytext" rows="15" id="content" style="width:100%;"  name="content" >${notice.content}</textarea>
			</div>
								...
								<td>
									<div class="light-button button-wrapper"
										...
										<div class="button" id="interest_add"
											onclick="javascript:updateNotice();">
											<span> 수정 </span>
										</div>
									</div>
								</td>
