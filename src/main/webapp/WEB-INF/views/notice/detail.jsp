...
<script type="text/javascript">
	...
	function update() {
		document.location.href = "${root}/notice.do/mvupdate?no=${notice.no}";
	}

	function deletenotice() {
		$("#detailform").attr("action", "${root}/notice.do/${notice.no}")
				.submit();
		alert("삭제가 완료되었습니다.");
	}
</script>
		...
		<div class="col-lg-6" align="center">
			...
			<form id="detailform" method="post" action="">
				...
				<div class="form-group" align="left">
					...
					<textarea class="mytext" style="width:100%;" rows="15" id="content"
						name="content" readonly>${notice.content}</textarea>
				</div>
							...
							<c:if test="${userinfo == 'admin'}">
								...
								<td>
									...
									<div class="light-button button-wrapper"
										style="display: inline;">
										<div class="button" id="interest_add"
											onclick="javascript:deletenotice();">
											<span> 삭제 </span>
										</div>
									</div>
								</td>
