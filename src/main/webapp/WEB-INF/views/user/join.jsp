...
$(document).ready(function() {
	$("#registerBtn").click(function() {
		/* var em = $('#email').val() + "@" + $('#emaildomain').val(); */
	    	$.ajax({
				type:'POST',
				url:'${pageContext.request.contextPath}/member.do/meminsert',
				data: { //JSON.stringify({
					  userid: $('#userid').val(),
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more"
				style="background-image: url('../img/join.jpg');"></div>
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">이름</span> <input class="input100"
						type="text" id="username" name="username" placeholder="이름을 입력하세요.">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Username is required">
					<span class="label-input100">ID</span> <input class="input100"
						type="text" id="userid" name="userid" placeholder="ID를 입력하세요.">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Repeat Password is required">
					...
					<input class="input100" type="password" id="pwdcheck" name="pwdcheck" placeholder="*************"> 
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Valid email is required: kimssafy@ssafy.com">
					<span class="label-input100">Email</span>
					<input class="input100" type="text" id="email" name="email" placeholder="kimssafy@ssafy.com"> 
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input" data-validate="Address is required">
					<span class="label-input100">주소</span> 
					<input class="input100" type="text" id="address" name="address" placeholder="주소를 입력하세요.">
					<span class="focus-input100"></span>
				</div>

				<div class="interest" align="left">
				<span class="label-input100">관심지역설정</span>
					<div class="form-select" id="default-select" align="center" style="width:100%">
						<table>
							<tr>
								<td><select id="sido">
					...
					<tr>
						<td>
							<div class="light-button button-wrapper" style="display: inline;">
								<div class="button" id="registerBtn">
									<span class="sspan"> 회원가입 </span>
								</div>
							</div>
						</td>
